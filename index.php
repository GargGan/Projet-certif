                   ...
                   <div class="square">
                       <div class="col-7">
                           ...
                           <div class="butlogging d-flex justify-content-center">
                               <a class="butlog text-decoration-none text-center" href="">Se connecter</a>
                           </div>
                       ...
                       <div class="col-7">
                           ...
                           <div class="mx-3 mt-4">
                               ...
                               <i class="fas prefix white-text mt-1 fa-user-circle"></i>
                                   <input type="text" id="defaultForm-text" class="form-control validate">
                               ...
                               <i class="fas fa-lock prefix white-text"></i>
                                   <input type="password" id="defaultForm-confirmpass" class="form-control validate">
                           ...
                           <div class="butinscription d-flex justify-content-center">
                               <a class="butlog text-decoration-none text-center" href="">S'inscrire</a>
                           </div>
                       </div>
                   </div>
                   <div class="square"></div>
